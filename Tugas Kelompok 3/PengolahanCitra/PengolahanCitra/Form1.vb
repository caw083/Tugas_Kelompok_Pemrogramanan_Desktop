...
PictureBox1.Image.Height.ToString)
    ...
    Public Sub ApplyWatermark(text As String)
        ...
        Dim textX As Integer = (bmp.Width) / 3
        Dim textY As Integer = (bmp.Height) / 2

        Using g As Graphics = Graphics.FromImage(bmp)
            g.DrawString(text, watermarkFont, New SolidBrush(Color.FromArgb(140, Color.Red)), textX, textY)
        End Using
